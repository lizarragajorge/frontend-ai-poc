...
@Component({
	...
	<div class="home-shell">
		...
		<div class="lower-grid">
			<div class="metrics card">
				...
				<div class="kpi-grid">
					<div class="kpi-box"><div class="kpi-value">--</div><div class="kpi-label">Data Products</div></div>
					<div class="kpi-box"><div class="kpi-value">--</div><div class="kpi-label">Models</div></div>
					<div class="kpi-box"><div class="kpi-value">--</div><div class="kpi-label">Agents</div></div>
					<div class="kpi-box"><div class="kpi-value">--</div><div class="kpi-label">Domains</div></div>
				</div>
			</div>
			<div class="psl card">
	...
	.hero-card:after { content:''; position:absolute; left:0; right:0; bottom:0; height:6px; background:linear-gradient(90deg,var(--brand) 0%, var(--brand-dark) 60%, var(--brand-dark) 100%); }
	...
	.section-head { font-size:13px; letter-spacing:1.1px; font-weight:800; text-transform:uppercase; color:var(--gray-700); margin:0 0 16px; position:relative; }
	.section-head:before { content:''; position:absolute; left:0; bottom:-7px; width:70px; height:3px; background:var(--brand); border-radius:3px; }
	...
	.kpi-box { background:#fff; border:1px solid var(--brand-light); border-radius:12px; padding:16px 18px 18px; display:flex; flex-direction:column; gap:10px; min-height:92px; }
	.kpi-value { font-size:26px; font-weight:700; color:var(--brand-dark); letter-spacing:.3px; }
